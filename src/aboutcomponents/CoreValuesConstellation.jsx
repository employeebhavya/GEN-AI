        ...
        <div className="hidden lg:block">
          <div className="relative w-[700px] h-[700px] mx-auto">
            ...
            <motion.div
              ...
              className="absolute w-32 h-32 rounded-full bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center shadow-2xl border-4 border-white"
              style={{
                left: centerX - 64,
                top: centerY - 64,
              }}
                ...
                >
                  ...
                  {hoveredValue === value.id && (
                    <motion.div
                      ...
                      className="absolute z-10 w-80 p-5 bg-white rounded-xl shadow-2xl border border-gray-200"
                      style={{
                        left: position.x > centerX ? "-320px" : "120px",
                        top: position.y > centerY ? "-140px" : "40px",
                      }}
                    >
                      <div className="flex items-center mb-3">
                        <div
                          className={`w-8 h-8 rounded-full bg-gradient-to-br ${value.color} flex items-center justify-center mr-3`}
                        >
