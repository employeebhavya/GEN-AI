            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-center">
              ...
              >
                <div className="relative">
                  {/* Mobile Frame */}
                  <div className="w-64 h-[520px] bg-gradient-to-br from-gray-800 to-gray-900 rounded-[2.5rem] p-4 shadow-2xl">
                    <div className="w-full h-full bg-gradient-to-br from-blue-50 to-purple-50 rounded-[2rem] p-4 relative overflow-hidden">
                      ...
                      <div className="space-y-3">
                            ...
                            <motion.div
                              ...
                              className={`bg-gradient-to-r ${section.gradient
                                ...
                                .replace(
                                  "600",
                                  "200"
                                )} p-3 rounded-xl hover:scale-105 transition-transform cursor-pointer`}
                            >
                              <div className="flex items-center gap-2.5">
                                <div
                                  className={`p-1.5 bg-gradient-to-br ${section.gradient} rounded-lg`}
                                >
                        ...
                        {/* Enhanced Mini Chart */}
                        <div className="bg-white/70 p-3 rounded-xl mt-4">
                  ...
                  <FloatingDataPoint delay={2.2}>
                    <div className="absolute -top-3 -right-3 w-12 h-12 bg-gradient-to-br from-purple-400/20 to-pink-400/20 rounded-full blur-lg" />
                  </FloatingDataPoint>
                  <FloatingDataPoint delay={2.5}>
                    <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-br from-blue-400/20 to-cyan-400/20 rounded-full blur-lg" />
                  </FloatingDataPoint>
                </div>
              </motion.div>
            </div>
